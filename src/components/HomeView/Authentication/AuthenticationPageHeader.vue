<template>
  ...
  >
    <template #extra>
      <a-button key="2" type="primary" @click="handleValidate"> Validate Token </a-button>
...
import { WarningTwoTone, CheckCircleTwoTone, CloseCircleTwoTone } from '@ant-design/icons-vue'
...
const encryption_status = computed(() => isEverythingEncrypted(connInfoStore.restful_endpoint))
...
const handleValidate = async () => {
  ...
  try {
    ...
    const response = await fetch(connInfoStore.restful_endpoint + 'management/data', {
      method: 'GET',
