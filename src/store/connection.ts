...
export const useConnectionInfoStore = defineStore('lablog-connection-info', () => {
  const connInfoState: RemovableRef<ConnectionInfoState> = useStorage(
    'lablog-connection-info-local-storage',
    {
      restful: {
        protocol: 'http://',
        host: '',
...
export const useConnectionStatusStore = defineStore('lablog-connection-status', () => {
...
export const useWebSocketManagerStore = defineStore('lablog-websocket-manager', () => {
